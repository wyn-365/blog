    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="${pageContext.request.contextPath}/admin/index.jsp">管理博客</a> </div>
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
        <li class="active"><a href="${pageContext.request.contextPath}/adminBlogServlet?method=blogUI&num=1">博客文章</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        ...
        <form action="${pageContext.request.contextPath}/adminBlogServlet?method=addProduct" method="post" class="add-article-form" enctype="multipart/form-data">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入关键字" autocomplete="off">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>公开度：</label><input type="radio"  checked/>公开 <input type="radio" />加密</p>      
              </div>
...
<div id="rightClickMenu">
  <ul class="list-group rightClickMenuList">
    <li class="list-group-item disabled">欢迎访问轩博客</li>
...
<script src="${pageContext.request.contextPath}/admin/lib/ueditor/ueditor.config.js"></script> 
<script src="${pageContext.request.contextPath}/admin/lib/ueditor/ueditor.all.min.js"> </script> 
<script src="${pageContext.request.contextPath}/admin/lib/ueditor/lang/zh-cn/zh-cn.js"></script>  
