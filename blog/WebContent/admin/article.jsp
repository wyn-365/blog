  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <h3><a href="${pageContext.request.contextPath}/adminBlogServlet?method=addArticle" style="color:green">写博客</a></h3>
         <table class="table table-striped table-hover">
            <thead>
              <tr>
                <th><span class="glyphicon glyphicon-th-large"></span> <span class="visible-lg">选择</span></th>
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">标题</span></th>
                 <th><span class="glyphicon glyphicon-picture"></span> <span class="visible-lg">博客图片</span></th>
                <th><span class="glyphicon glyphicon-list"></span> <span class="visible-lg">栏目分类</span></th>
                <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">前台显示</span></th>
                <th class="hidden-sm"><span class="glyphicon glyphicon-heart-empty"></span> <span class="visible-lg">是否热门</span></th>
            ...
            <c:forEach items="${page.list}" var="p">
	              <tr>
	                ...
	                <td class="article-title">${p.title}</td>
	                 <td><img src="${pageContext.request.contextPath}/${p.bimage}" height="30" width="40" ></td>
	                <td>${p.cid}</td>
	                <td class="hidden-sm">${p.bflag}</td>
	                <td class="hidden-sm">${p.is_hot}</td>
	                <td class="hidden-sm">${p.bcomment}</td>
	                <td class="hidden-sm">${p.browse}</td>
	                <td>${p.bdate}</td>
	                <td><a href="">修改</a> <a href="${pageContext.request.contextPath}/adminBlogServlet?method=deleteBlog&id=${p.id}">删除</a></td>
	              </tr>
            </c:forEach>
