          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-eye-close"></span> <span class="visible-lg">密码</span></th>
                <th><span class="glyphicon glyphicon-hand-down"></span> <span class="visible-lg">姓名</span></th>
                <th><span class="glyphicon glyphicon-tree-conifer"></span> <span class="visible-lg">姓别</span></th>
                <th><span class="glyphicon glyphicon-envelope"></span> <span class="visible-lg">邮箱</span></th>
                <th><span class="glyphicon glyphicon-earphone"></span> <span class="visible-lg">电话</span></th>
                <th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">生日</span></th>
                <th><span class="glyphicon glyphicon-apple"></span> <span class="visible-lg">是否可用</span></th>
            ...
            <c:forEach items="${users}" var = "u" varStatus="v">
              <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/adminUserServlet?method=updateUser&uid=${u.uid}">启用</a> <a href="${pageContext.request.contextPath}/adminUserServlet?method=deleteUser&uid=${u.uid}">删除</a>
                
                 <a href="${pageContext.request.contextPath}/adminUserServlet?method=jinUser&uid=${u.uid}">禁用</a></td>
              </tr>
             </c:forEach>
            </tbody>
          </table>
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <form action="${pageContext.request.contextPath}/adminUserServlet?method=addUser" method="post" autocomplete="off" draggable="false">
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td width="20%">电话:</td>
                <td width="80%"><input type="text" value="" class="form-control" name="telephone" maxlength="13" autocomplete="off" /></td>
              </tr>
               <tr>
                <td width="20%">邮箱:</td>
                <td width="80%"><input type="text" value="" class="form-control" name="telephone" maxlength="13" autocomplete="off" /></td>
