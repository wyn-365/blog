    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="${pageContext.request.contextPath}/admin/index.jsp">博客管理后台</a> </div>
          ...
          <ul class="dropdown-menu" aria-labelledby="userMenu">
            ...
            <li><a href="${pageContext.request.contextPath}/adminBlogServlet?method=userUI">管理用户</a></li>
   			 ...
   			 <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
       				 <h1 class="page-header" style="color:red;text-align: center">欢迎您回来，${loginUser2.username} <span class="badge">3</span></h1>
         	 </div>
    </div>
