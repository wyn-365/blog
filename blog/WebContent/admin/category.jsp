    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <form action="${pageContext.request.contextPath}/adminBlogServlet?method=addCategory" method="post" autocomplete="off">
            <div class="form-group">
              <label for="category-name">分类名称</label>
              <input type="text" id="category-name" name="cname" class="form-control" placeholder="在此处输入栏目名称" required autocomplete="off">
              <span class="prompt-text">这将是它在站点上显示分类的名字。</span> </div>
        ...
        <div class="col-md-7">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
               <c:forEach items="${allCats}" var = "c" varStatus="v">
                <tr>
                  <td>${v.count}</td>
                  <td>${c.cname}</td>
                  
                  <td><a href="">修改</a> <a href="${pageContext.request.contextPath}/adminBlogServlet?method=deleteCategory&cid=${c.cid}">删除</a></td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
