          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">日期</span></th>
                  <th><span class="glyphicon glyphicon-user"></span> <span class="visible-lg">评论用户ID</span></th>
                    <th><span class="glyphicon glyphicon-heart-empty"></span> <span class="visible-lg">所在微博</span></th>
                     <th><span class="glyphicon glyphicon-heart-empty"></span> <span class="visible-lg">回复评论</span></th>
            ...
            <c:forEach items="${page.list}" var = "c">
              <tr>
                ...
                <td class="article-title">${c.content}</td>
                <td>${c.cdate}</td>
                <td>${c.uid}</td>
                <td>${c.blog_id}</td>
                 <form action="${pageContext.request.contextPath}/adminBlogServlet?method=getRcomment" method="post">
                 <td>
                 
                 	<input type="text" name="rcomment"/>
                 	<input type="hidden" name="id" value="${c.id}"/>
                 	
                 	<td><button type="submit">回复</button></td>
                 </td>
                 </form>
                <td> <a href="${pageContext.request.contextPath}/adminBlogServlet?method=deleteComment&id=${c.id}">删除</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
